...
constexpr float PALETTE_TOP = 8.0f;                ///< Haut de la première ligne (palette, 7 types).
/// Haut de la première ligne de la barre d'outils (sous les 7 lignes de la palette).
constexpr float TOOLBAR_TOP = PALETTE_TOP + 7.0f * PANEL_ROW_PITCH + PANEL_SECTION_GAP;
