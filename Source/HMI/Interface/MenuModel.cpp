...
/// @return Le nombre de **code points** UTF-8 de @p text (un octet de continuation n'en est pas un).
...
/**
 * @brief Indice de l'option dont le rectangle contient (@p x, @p y), ou -1.
 *
