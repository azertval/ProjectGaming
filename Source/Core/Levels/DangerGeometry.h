 ...
 */
inline constexpr float DANGER_EDGE_THICKNESS = 0.25f;
 ...
 * (`DANGER_EDGE_THICKNESS`) alignée sur le bord désigné pour les quatre variantes directionnelles :
 ...
 * @param column  Colonne de la case (unités de grille).
 * @param row  Ligne de la case (unités de grille).
 * @return Le rectangle mortel, en unités de grille.
 */
[[nodiscard]] Aabb dangerHitbox(TileType type, int column, int row) noexcept;
