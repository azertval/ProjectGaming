...
> **API de bibliothèque.** `CrossLevelBenchmark` n'a volontairement **aucun point d'entrée**
> `aisolver-cli` : la campagne de transfert du `LOT-ANNEXE-16` a été exécutée une fois et ses
