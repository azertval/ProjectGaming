 ...
 *
 * Alimentée par la taxonomie pure (`editor::tileTaxonomy`), elle remplace l'accordéon « maison »
 * (`hmi::TilePalette`) par un contrôle Qt natif (`EX-EDIT-018`, `EX-IHM-010`). Sélectionner une
